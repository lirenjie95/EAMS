...
| 8 | 专业 |   | Char |   |   |   |
| 9 | 专业编号 |   | Char | 11 | 非空，唯一 |   |
| 10 | 课程编号 |   | Char | 20 | 非空，唯一 |   |
| 11 | 课程名称 |   | Char |   | 非空 |   |
| 12 | 课程属性 |   | Char |   | 非空 |   |
| 13 | 学分要求 |   | Integer |   |   |   |
| 14 | 授课教师 | 记录在排课表 | Char |   | 非空 |   |
| 15 | 学分 |   | Integer |   | 非空 |   |
| 16 | 人数限制 |   | Integer |   | 非空 |   |
| 17 | 实际人数 |   | Integer |   |   |   |
| 18 | 学期 |   | Char |   | 非空 |   |
...
| --- | --- | --- | --- |
| 1 | 个人信息 | 记录个人信息，分为学生个人信息和教师个人信息两张表 | 学号/工号、姓名、性别、出生年月、年级、联系方式、专业、院系 |
| 2  | 院系名称表 | 对照院系编号和院系名称 | 院系编号、院系名称 |
...
| 编号 | 数据储存名 | 输入 | 输出 | 说明 |
| --- | --- | --- | --- | --- |
| 1 | 学生个人信息 | 学号、密码、姓名、性别、出生年月、年级、联系方式、专业、院系名称 | 个人信息 | 与教师个人信息 |
| 2 | 教师个人信息 | 工号、密码、姓名、性别、出生年月、联系方式、专业、院系名称 | 个人信息 |   |
| 3 | 排课表 | 课程编号、课程名称、学分、上课时间、授课教师、（教师）工号、学期、课程属性 | 排课表 |   |
| 4 | 课程教材表 | 课程编号、课程名称、授课教师、课程教材 |   |   |
| 5 | 选课表 | 学号（登录）课程编号（选课）分数 | 选课表、学生课程表、课程名单、成绩单、修读计划完成情况 | 选课表SC包含课程编号、课程名称、学号、姓名、学期、成绩等属性，将过去的选课记录和现时的选课记录在一张表中。分数为百分制。 |
...
课程（**课程编号**，课程名称，课程属性，人数限制，实际人数，学分）
...
排课表（**课程编号**、课程名称、学分、上课时间、工号、学期、课程属性）

选课表（**课程编号**、**学号**、**学期**、成绩），前三个作为主码

课程教材表（**课程编号**、**工号**、**ISBN编码**），三个主属性合并为主码
...
**排课表** BCNF （**课程编号**、课程名称、学分、上课时间、工号、学期、课程属性）
...
**课程教材表** BCNF（**课程编号**、**工号**、**ISBN编码**），三个主属性合并为主码
